														...
														<c:choose>
															<c:when test="${empty att}">
																<button type="button" class="btn btn-primary mt-2 mb-3"
																	onclick="attIn()"
																	style="width:100px;">출근</button><br>
																<button type="button" class="btn btn-outline-primary"
																	onclick="attOut()" style="width:100px;"
																	disabled>퇴근</button>
															</c:when>
															<c:when test="${att.attState eq 1 and att.attOut eq null}">
																<button type="button"
																	class="btn btn-outline-primary mb-3"
																	onclick="attIn()" style="width:100px;"
																	disabled>출근</button><br>
																<button type="button" class="btn btn-primary"
																	onclick="attOut()" style="width:100px;">퇴근</button>
															</c:when>
															<c:otherwise>
																<button type="button"
																	class="btn btn-outline-primary mb-3"
