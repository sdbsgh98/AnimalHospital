									...
									<div>
										...
										<div class="mb-3 row">
											<label for="name" class="col-sm-2 col-form-label" style="text-align: center; font-weight: bold; font-size: medium;">보호자</label>
										    	<div class="col-sm-10">
										     		<input type="text" name="name" class="form-control" id="name" placeholder="보호자이름을 입력하세요.">
										    	</div>
										</div>
										<div class="mb-3 row">
										...
										<button type="submit" id="btn" class="btn btn-primary" style="float: right; margin-top: 20px; margin-bottom: 20px; margin-right: 10px;">등록</button>
									</div>
								</div>
							</form>
						</div>
