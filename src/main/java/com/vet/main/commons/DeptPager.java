...
public class DeptPager {
	private Long page;  //page 번호를 담을 변수
	private Long perPage; //한 페이지에 보여줄 글의 갯수
	private Long startRow; //시작 index 번호
	//오라클과는 달리 LIMIT를 사용하기 때문에, lastRow가 필요없음.
	
	private Long totalPage; //전체 페이지 갯수
	private Long perBlock; //한 블럭당 출력할 페이지수
	private Long startNum; //한블럭 내 시작번호
	private Long lastNum; //한블럭 내 끝번호
